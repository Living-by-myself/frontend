...
export type GroupBuyCategoryShare =
  (typeof GROUP_BUY_CATEGORY_SHARE)[keyof typeof GROUP_BUY_CATEGORY_SHARE];
...
export type GroupBuyStatus =
  (typeof GROUP_BUY_STATUS)[keyof typeof GROUP_BUY_STATUS];
